...
const IG_POST_HASHTAGS = "#LinglingKwong #Ling\n#Dior #DiorAW26 #pfw";
const IG_POST_TAG = "@dior @linglingsirilak";
const IG_POST_COPY = `${IG_POST_HASHTAGS}\n${IG_POST_TAG}`;

const IG_STORY_HASHTAGS = "#LinglingKwong #Ling\n#DiorAW26 #pfw";

const TAG_IN_PHOTO_NOTE = "Tag in photo: @dior @linglingkwong @parisfashionweek";
