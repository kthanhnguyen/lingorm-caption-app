...
const IG_POST_HASHTAGS = "#OrmKornnaphat #Orm\n#Dior #DiorAW26 #pfw";
const IG_POST_TAG = "@dior @ormmormm";
const IG_POST_COPY = `${IG_POST_HASHTAGS}\n${IG_POST_TAG}`;

const IG_STORY_HASHTAGS = "#OrmKornnaphat #Orm\n#DiorAW26 #pfw";

const TAG_IN_PHOTO_NOTE = "Tag in photo: @dior @orm.kornnaphat @parisfashionweek";

export default function TabIGOrm() {
