...
export default function TabXLing() {
  ...
  const generateCaption = async () => {
    ...
    setError(null);
    try {
      const res = await fetch("/api/generate?category=ling", { method: "POST" });
    ...
    <>
      ...
      <div className={CARD_CLASS}>
        ...
        <p className="mb-4 text-sm text-white/80">
          Choose a preset below to copy hashtags for your post (Ling).
        </p>
